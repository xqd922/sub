...
import { IconClockCircle, IconCloud, IconSafe, IconStorage, IconSync } from '@arco-design/web-react/icon'
...
export function DiagnosticsPanel({
  ...
  const healthItems = [
    ...
    },
    {
      ...
      color: 'arcoblue',
      icon: <IconCloud />,
      description: '管理 API 与订阅转换接口通过 OpenNext 运行在 Cloudflare Workers。'
    },
    {
      title: '刷新策略',
