...
import { AppError, ErrorCode, ErrorFactory } from '@/src/infrastructure/errors/errors'
import { handleError, createErrorResponse } from '@/src/infrastructure/errors/reporter'
import { RecordService } from '@/src/infrastructure/storage/kv'
import { getCloudflareRuntime } from '@/src/infrastructure/cloudflare/context'
...
export class CoreService {
  ...
  static async handleRequest(request: Request): Promise<NextResponse> {
    ...
    try {
      ...
      const ctx = getCloudflareRuntime()?.ctx
