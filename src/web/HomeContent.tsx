...
const capabilities = [
  {
    title: "自动识别客户端",
    description:
      "根据请求端自动输出 Clash、Sing-box、v2rayNG 或 HTML 预览。",
    icon: <IconSync />,
  },
  {
    title: "Workers Runtime",
    description:
      "转换、记录和短链链路运行在 Cloudflare Workers，适合轻量高频访问。",
    icon: <IconCloud />,
  },
  {
    title: "安全可观测",
...
export function HomeContent() {
  ...
  const { shortUrl, shortenLoading, generateShortUrl, setShortUrl } =
    useShortUrl();
        ...
        <section className="public-hero">
          ...
          <Card className="converter-card" bordered={false}>
            <div className="converter-card-head">
              ...
              <span className="converter-head-icon">
                <IconCode />
              </span>
            </div>
